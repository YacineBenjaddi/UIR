...
<div class="container-xl">
    <div class="table-responsive" id="page">
        <div class="table-wrapper" style="width: 100%;">
            <div class="table-title" >
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Reservations <b>Foot</b></h2>
                    </div>
                    <div class="col-sm-6">

                    <button class="btn btn-danger delete_all" data-url="{{ url('deleteAllFoot') }}"><i class="material-icons">&#xE15C;</i> <span>Supprimer La Selection</span></button>  
  ...
  padding: 10px;" class="custom-checkbox"  type="checkbox" id="master"></th>
           ...
           <tbody>
                      @if(count($foot) > 0)
                         @foreach($foot->all() as $foot)
                <tr id="tr_{{$foot->id_res}}">
                    <td><input type="checkbox" class="sub_chk" data-id="{{$foot->id_res}}"></td>
                       <td>{{ $foot->id_res }}</td>
...
<td>
                   <a role="button" data-target="#deleteEmployeeModal-{{ $foot->id_res }}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>

           <div id="deleteEmployeeModal-{{ $foot->id_res }}" class="modal fade" tabIndex="-1">
        ...
        <div class="modal-content">
            <form>
                ...
                <div class="modal-footer">
                    ...
                    <a href='{{ url("/deleteFoot/{$foot->id_res}") }}'class="btn btn-danger">Delete</a> 
                </div>
            </form>
        </div>
    </div>
