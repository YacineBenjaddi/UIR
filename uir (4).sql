...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 20 nov. 2020 à 18:29
...
--
-- Structure de la table `horaire_piscine`
--

CREATE TABLE `horaire_piscine` (
  `id_horaire` int(11) NOT NULL,
  `creneau` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `horaire_piscine`
--

INSERT INTO `horaire_piscine` (`id_horaire`, `creneau`) VALUES
(8, '8:00-9:00'),
(9, '9:00 - 10:00'),
(10, '10:00 - 11:00'),
(11, '11:00 - 12:00'),
...
(3, 'Tennis', 'Disponible de 8h30-00h00', '33.984440', '-6.722974', 'tennis', 1),
(4, 'Salle de Musculation', 'Disponible de 17h-22h', '33.986215', '-6.721950', 'muscu', 5),
(5, 'Basket', 'Disponible de 8h30-00h00', '33.984722', '-6.722662', 'basket', 1);
...
(2, 6, 20, '2020-11-20', 'basket'),
(19, 3, 14, '2020-11-22', 'basket'),
...
(1, 1, 18, '2020-11-16', 'piscine'),
(2, 4, 14, '2020-11-22', 'piscine'),
(3, 5, 14, '2020-11-22', 'piscine'),
(6, 3, 14, '2020-11-22', 'piscine'),
(7, 6, 14, '2020-11-22', 'piscine');
...
(4, 'manal', 'el ouardani', 'manal', '123', 0, 'female', 'User', 0, '159786', '5 eme', 'ISI', 0, '0000-00-00', '0000-00-00', ''),
...
(7, 'basma', 'guermah', 'basma.guermah@uir.ac.ma', '123456', 0, 'female', 'Personnel', 0, '0', '2020/2021', 'Ingenierie d\'informatique', 0, '0000-00-00', '0000-00-00', '');
...
--
-- Index pour la table `horaire_piscine`
--
ALTER TABLE `horaire_piscine`
  ADD PRIMARY KEY (`id_horaire`);
...
--
-- AUTO_INCREMENT pour la table `horaire_piscine`
--
ALTER TABLE `horaire_piscine`
  MODIFY `id_horaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `reservation_basket`
  MODIFY `id_res` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `reservation_piscine`
  ADD CONSTRAINT `reservation_piscine_ibfk_1` FOREIGN KEY (`id_horaire`) REFERENCES `horaire_piscine` (`id_horaire`),
