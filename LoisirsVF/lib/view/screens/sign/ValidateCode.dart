...
class _ValidateCodeState extends State<ValidateCode> {
  ...
  sendMail() async {
    String username = "uirhobbies@gmail.com";
    String password = "uirhobbies123"; //passsword
...
// e.toString() will show why the email is not sending
 ...
 /* submit() async {
  ...
  submit()async{
    final response = await Services.ValidateCode(widget.email, code);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          IconButton(icon: Icon(Icons.error_outline), onPressed: null),
           Text(
            "                 To receive the verification code in your mailbox \n"
