...
class _SignupEmailState extends State<SignupEmail> {
  ...
  Future<String> Check() async {
    String result = await Services.check(email.text);
print('cheeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeck 22222 $result');
  //  var datauser = json.decode(result);
    ...
    if(result=="success"){
print("lllllllllllllllllllllkkkkkkkkkkkkkkkkkkkkkkkkk");
      var route = new MaterialPageRoute(
        builder: (BuildContext context) => new SignupPassword( email.text),
      );
      Navigator.of(context).push(route);
