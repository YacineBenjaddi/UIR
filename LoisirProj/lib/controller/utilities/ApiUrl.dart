class ApiUrl{
  ...
  static String check = 'http://192.168.1.4/Test/check.php';
  static String addpassword = 'http://192.168.1.4/Test/AddPassword.php';
  ...
  static String get = "http://192.168.1.4/Test/comments.php";
  static String add = "http://192.168.1.4/Test/CommentDB.php";
